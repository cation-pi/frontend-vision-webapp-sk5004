...
with tab1:
    st.warning("📱 **Pengguna HP**: Pada menu Upload, mohon pilih gambar dari Galeri/Perpustakaan Foto. Pengambilan foto langsung melalui menu tersebut belum stabil dan dapat menyebabkan proses unggah gagal. Untuk mengambil foto secara langsung dari kamera, gunakan tab **📸 Kamera Web**.")
