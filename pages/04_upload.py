...
with tab1:
    st.warning("📱 **Pengguna HP**: Mohon pilih gambar dari Galeri pada menu Upload. Pengambilan foto langsung dari kamera pada menu tersebut belum stabil dan dapat menyebabkan proses unggah gagal. Untuk mengambil foto secara langsung dari kamera, gunakan tab **📸 Kamera Web**.")
